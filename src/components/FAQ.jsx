  ...
  const faqs = [
    {
      ...
      answer:
        "Doulas are welcome in any birth setting — hospitals, birth centres, and home births. In fact, hospital births are where many families find doula support most valuable. When you're navigating an unfamiliar environment with rotating staff and medical interventions, having one consistent person who knows your wishes makes all the difference. I'll work alongside your medical team, not against them.",
    },
    {
      question: 'When should I book a doula?',
      answer:
        "For birth doula support, the earlier the better, ideally during your second trimester. This gives us time to build a relationship, work through your birth preferences, and make sure you feel fully prepared. That said, if your due date is approaching, that's great too. Reach out and let's talk.\n\nFor postpartum doula support, you can book anytime, including after the baby arrives. Many families don't realize they need support until then.",
    },
    {
      question: 'What if my partner feels replaced?',
      answer:
        "This is a common concern, and I take it seriously. My job isn't to replace your partner — it's to empower them. During labour, I guide partners on how to help with comfort measures, when to offer support, and when to step back. Most partners tell me afterward that they felt more involved, not less.",
    },
    {
