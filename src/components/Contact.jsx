      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-charcoal-light max-w-2xl mx-auto">
            Whether you're planning for birth, navigating postpartum, or anywhere in between, I'm here to support you. Let's connect with a no-pressure discovery call to see if working together feels like the right fit.
          </p>
        </motion.div>
